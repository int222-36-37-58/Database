...
CREATE TABLE IF NOT EXISTS `int222`.`Comment` (
  ...
  `productId` INT NOT NULL,
  PRIMARY KEY (`commentId`, `User_userId`),
  INDEX `fk_Comment_User1_idx` (`User_userId` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `int222`.`OrderDetail` (
  ...
  `colorId` INT NOT NULL,
  `productId` INT NOT NULL,
  PRIMARY KEY (`orderDetailId`, `orderId`, `colorId`, `productId`),
